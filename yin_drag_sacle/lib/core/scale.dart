...
class ScaleStartDetails {
  ...
  ScaleStartDetails({this.focalPoint = Offset.zero}) : assert(focalPoint != null);
...
class ScaleGestureRecognizer extends OneSequenceGestureRecognizer {
  ...
  void _registerSecondTap(PointerEvent event) {
    if (onDoubleTap != null) invokeCallback<void>('onDoubleTap', () => onDoubleTap(DoubleDetails(pointerEvent: event)));
    _reset();
  }
  ...
  void _advanceStateMachine(bool shouldStartIfAccepted, PointerEvent pointerEvent) {
