...
import 'package:flutter/src/widgets/framework.dart'
    show StatelessWidget, StatefulWidget, State, Widget, Element, BuildContext, SingleChildRenderObjectWidget;
import './scale.dart';
...
class RawGestureDetectorState extends State<RawGestureDetector> {
  ...
  Widget build(BuildContext context) {
    Widget result =
        Listener(onPointerDown: _handlePointerDown, behavior: widget.behavior ?? _defaultBehavior, child: widget.child);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    if (_recognizers == null) {
      ...
      final List<String> gestures =
          _recognizers.values.map<String>((GestureRecognizer recognizer) => recognizer.debugDescription).toList();
      properties.add(IterableProperty<String>('gestures', gestures, ifEmpty: '<none>'));
      properties
          .add(IterableProperty<GestureRecognizer>('recognizers', _recognizers.values, level: DiagnosticLevel.fine));
    }
